...
export default function Banner() {
  return (
    <div>
      <div style={{position: 'relative'}}><img style={{width: '100%', marginTop: '-50px'}} src={BannerImg} /></div>
      <div style={{ display: 'flex', alignItems: 'center', width: '70%', height: '30%', background: '#332706', opacity: '0.8', position: 'absolute', top: '70px', left: '0'}}>
